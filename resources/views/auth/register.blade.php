<x-guest-layout>
    ...
    <p class="mt-1 text-sm text-slate-500">Daftar untuk mengakses sistem manajemen armada PLN.</p>
    ...
    <form method="POST" action="{{ route('register') }}" class="mt-8 space-y-5">
        ...
        <p class="text-center text-sm text-slate-500">
            Sudah punya akun?
            <a href="{{ route('login') }}" class="font-medium text-[#08203E] hover:underline">Masuk</a>
        </p>
    </form>
</x-guest-layout>